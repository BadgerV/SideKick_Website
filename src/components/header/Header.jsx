...
const Header = () => {
  ...
  const [openOrClosed, setOpenOrClosed] = useState("none");

  const action = () => {
    setOpen(!open);
    if (open) {
      setOpenOrClosed("none");
    } else {
      setOpenOrClosed("block");
    }
  };
    ...
    <div className="header">
      <div className="header_top">
        <div className="smallScreen">
          <ul className="white_background">
            <li className="small_screen_menu_item">Menu</li>
            <li className="small_screen_menu_item">slfoh</li>
            <li className="small_screen_menu_item">welfih</li>
            <li className="small_screen_menu_item">liuefsn</li>
            <li className="small_screen_menu_item">lsioefj</li>
          </ul>
        </div>
        <span className="menu_icon" onClick={action}>
